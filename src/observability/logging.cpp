...
void BusinessLog::TaskCreated(const std::string& user_id,
...
void BusinessLog::TaskCompleted(const std::string& user_id,
                                  const std::string& task_id) {
...
void BusinessLog::SessionStarted(const std::string& user_id,
...
void BusinessLog::SessionCompleted(const std::string& user_id,
                                     const std::string& session_id,
                                     int minutes) {
...
void BusinessLog::ReminderSent(const std::string& user_id,
