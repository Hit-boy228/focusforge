...
private:
    void HandleTaskCallback(const dto::TgCallbackQuery& cq,
                             const std::vector<std::string>& parts);
    void HandleFocusCallback(const dto::TgCallbackQuery& cq,
                              const std::vector<std::string>& parts);
    void HandleReminderCallback(const dto::TgCallbackQuery& cq,
                                 const std::vector<std::string>& parts);
    void HandleMenuCallback(const dto::TgCallbackQuery& cq,
                             const std::vector<std::string>& parts);
    void AnswerCallback(const std::string& callback_id,
