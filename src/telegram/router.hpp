...
namespace focusforge::telegram { class CallbackRouter; }
namespace focusforge::telegram::scenes {
class StartScene; class CreateTaskScene; class EditTaskScene;
class FocusScene; class ReminderScene;   class ReviewScene;
}
namespace focusforge::services {
class ConversationService; class UserService;
class NotificationService; class TaskService;
class AnalyticsService;    class StreakService;
class ReminderService;     class PlannerService;
}
...
private:
    ...
    void HandleCommand(const dto::TgMessage& msg,
