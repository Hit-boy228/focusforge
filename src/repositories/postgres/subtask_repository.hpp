...
public:
    ...
    domain::Subtask Insert(userver::storages::postgres::Transaction& trx,
                            const domain::Subtask& s);
    void ToggleDone(userver::storages::postgres::Transaction& trx,
                    const std::string& subtask_id, bool is_done);
    void DeleteByTaskId(userver::storages::postgres::Transaction& trx,
