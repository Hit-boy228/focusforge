...
std::vector<domain::Subtask> SubtaskRepository::FindByTaskId(
...
domain::Subtask SubtaskRepository::Insert(
    pg::Transaction& trx, const domain::Subtask& s) {
    static constexpr auto kQ = R"~(
...
void SubtaskRepository::ToggleDone(
    pg::Transaction& trx, const std::string& subtask_id, bool is_done) {
    static constexpr auto kQ = R"~(
...
void SubtaskRepository::DeleteByTaskId(
    pg::Transaction& trx, const std::string& task_id) {
